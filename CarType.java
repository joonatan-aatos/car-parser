...
KIA_NIRO(183, 8.9, 21.3, 3.3, 0.0, new ArrayList<String>(Arrays.asList("Type2"))), 
...
RENAULT_ZOE(292, 41.0, 15.5, 22.0, 0.0, new ArrayList<String>(Arrays.asList("Type2"))), 
...
SMART_EQ(15, 17.6, 16.5, 22.0, 0.0, new ArrayList<String>(Arrays.asList("Type2"))), 
